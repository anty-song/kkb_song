...
jQuery(document).ready(function ($) {
    $("#spig").mousedown(function (e) {
        if(e.which==3){
        showMessage("恭喜你，发现秘密通道:<br /><br /><a href=\"http://www.kaikeba.com/\" title=\"开课吧\">开课吧</a>",10000);
}
});
...
jQuery(document).ready(function ($) {
    ...
    $(".mumu").mouseover(function () {
       $(".mumu").fadeTo("300", 0.3);
       msgs = ["扫我呀~ 扫我我就跟你玩~ ", "我会隐身哦！嘿嘿！", "你把手拿开我就出来！"];
...
jQuery(document).ready(function ($) {
    ...
    window.setInterval(function () {
        msgs = ["好无聊哦，你都不陪我玩~", "…@……!………", "^%#&*!@*(&#)(!)(", "我是小甲鱼的小小助理哦~_~", "我可爱吧！嘻嘻!~^_^!~~","谁淫荡呀?~谁淫荡?，你淫荡呀!~~你淫荡！~~","从前有座山，山上有座庙，庙里有个老和尚给小和尚讲故事，讲：“从前有座……”"];
        var i = Math.floor(Math.random() * msgs.length);
